...
#    mobility_schedule = make_mobility_schedule(schedule_type="poly_decay", a0=20.0, a_min=0.2, power=1.0)
...
#        guide_weight_fn = make_guide_weight_schedule(schedule_type="poly_rise", weight=5000.0, power=1.0)
#        guide_weight_fn = make_guide_weight_schedule(schedule_type="constant", weight=1000.0, power=1.0)
        guide_weight_fn = make_guide_weight_schedule(schedule_type="constant", weight=200.0, power=1.0)
